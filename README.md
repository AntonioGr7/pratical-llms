...
| 9_inference_big_model_cpu_plus_gpu.ipynb | "This notebook shows how to calculate the RAM required by a quantized GGUF model and how to load it into memory using both RAM and VRAM, optimizing the number of layers that can be offloaded to the GPU. The notebook demonstrates loading Qwen/Qwen1.5-32B-Chat as an example on a system with a T4 15GB VRAM and approximately 32GB of RAM | [Link](https://github.com/AntonioGr7/pratical-llms/blob/main/9_inference_big_model_cpu_plus_gpu.ipynb) |
